...
public class YamlConfig {
    ...
    public void reloadConfig() {
        ...
        InputStream defaultStream = Origin.getPlugin().getResource(fileName);
    ...
    public void saveConfig() {
        ...
        try {
            ...
            Origin.getPlugin().getLogger().log(Level.SEVERE, "Could not save config to " + this.configFile, e);
        }
    }
    ...
    public void saveDefaultConfig() {
        ...
        if (!(this.configFile.exists())) {
            try {
                Origin.getPlugin().saveResource(fileName, false);
