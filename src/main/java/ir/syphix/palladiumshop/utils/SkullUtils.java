...
public class SkullUtils {
    ...
    public static HashMap<UUID, String> PLAYER_HEAD_TEXTURE = new HashMap<>();

    public static ItemStack skullFromTexture(String url) {
        ...
        GameProfile profile = new GameProfile(UUID.randomUUID(), String.valueOf(UUID.randomUUID()));
